...
from common.utils import init_arg_parser, check_config, rotate_checkpoints, \
    set_seed, logger, load_pretrained, save_pretrained
from common.data import load_and_cache_examples
...
if __name__ == '__main__':
    ...
    config, model, tokenizer = load_pretrained(args, config_class, model_class, tokenizer_class)
    ...
    if "train" in args.mode:
        ...
        train_dataset = load_and_cache_examples(args, tokenizer, evaluate=False, enc_dec=args.enc_dec)
        ...
        save_pretrained(args, config, model, tokenizer)

    ## Evaluating ##
    if "eval" in args.mode and args.local_rank in [-1, 0]:
        results = {}
